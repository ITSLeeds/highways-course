...
We're looking forward to the upcoming R for transport course we're running at the University of Leeds, 15th-16th November. This email contains some information about the course including vital timings and pre-requisites.
...
- Spatial data in R
- R's spatial ecosystem (see section [1.4 of Geocomputation with R - the ecosystem data](https://geocompr.robinlovelace.net/intro.html#rs-spatial-ecosystem))
