...
The aim of R for Highways Research and Transport Planning is to provide content for a 2 day course on R and transport data with R.
...
- Bonus (relies on internet/data): try to read-in and analyse datasets you use at work as data frames or sf objects. 
...
plot(line_lnd, add = TRUE, lwd = 5, col =)
```
